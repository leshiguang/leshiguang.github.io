<a name="7bc4c412"></a>
# 一、接入模式介绍
![image.png](https://cdn.nlark.com/yuque/0/2020/png/265997/1597931375225-0cbee956-578e-414c-8a5e-7f720f7cd497.png#align=left&display=inline&height=478&margin=%5Bobject%20Object%5D&name=image.png&originHeight=478&originWidth=1017&size=68514&status=done&style=none&width=1017)<br />1、设备通过乐心提供的蓝牙SDK上传数据到乐心服务器<br />2、账号信息通过乐心提供的SDK打通<br />3、基于蓝牙SDK之上，通过乐心的SDK将数据上报给乐心IoT平台，同时将数据回调给客户APP<br />4、客户应用和乐心SDK对接，嵌入SDK中的页面
<a name="eBqBc"></a>
# 二、快速集成
...
- lifesense-android-common-service: 底层的基础库， 处理文件、cookie和一些工具类
- lifesense-android-webview-service：webview实现部分， 处理webview的桥接口、缓存等逻辑
- lifesense-android-health-service：健康服务部分、主要处理UI部分，UI页面的入口
