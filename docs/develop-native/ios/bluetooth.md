...
<a name="uXcWS"></a>
### 8.2.12、didMeasureDataUpdateForWifi (蓝牙wifi双模秤扫描wifi数据回调）
...
- 详细说明：开启爆款wifi扫描的回调
<a name="zBPlv"></a>
### 8.2.13、didConnectWifiResult （蓝牙wifi双模秤wifi配网结果回调）
...
<a name="4c326434"></a>
### 9.1.11、LSDeviceUpgradeStatus（OTA升级状态）
...
<a name="3c506cac"></a>
### 9.1.15、LSDeviceOperationCmd（设备上报的指令）
...
<a name="ef94adb6"></a>
### 9.1.16、LSBroadcastNameMatchWay（广播匹配方式）
...
<a name="19d52bf3"></a>
### 9.2.3、LSDeviceOperationCmdInfo（绑定操作命令）
id cmdObj 操作指令内容<br />LSDeviceOperationCmd operationCmd 操作指令
<a name="3dfcd23b"></a>
### 9.2.4、LSDeviceEventReminderInfo（时间提醒）
