<a name="c5lzF"></a>
# 运动报告
类名：com.lifesense.android.ble.device.band.model.SportReport
...
| sportTime | int | 运动时长（不包括暂停数据）（没有测量到数据为-1） | 跑步、健走、骑行、游泳、健身、跑步机、椭圆机、有氧运动、篮球、足球、羽毛球、排球、乒乓球、瑜伽、有氧能力12分钟跑、有氧能力6分钟走、健身舞、太极 |
...
| armPull | int | 划水次数 | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
| stroke | int | 泳姿 | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
| swolf | int | 游泳效率值 | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
| maxSprintSpeed | int | 最大冲刺速度 | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
| maxPitchHeartRate | int | 最大步频心率 | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
| targetValue | int | 运动目标值 | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
| targetState | int | 运动目标完成状态 0：无目标 1目标达成 2目标未达成 | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
| targetType | int | 运动目标类型<br />步数（单位：步数）<br />卡路里/热量（单位：0.1Kcal）<br />距离（单位：米）<br />深睡眠<br />站立时长（单位：分钟）<br />运动时长（单位：分钟）<br />趟数（游泳运动） | 仅Hr6、Mambo Watch1、Mambo Watch2支持 |
